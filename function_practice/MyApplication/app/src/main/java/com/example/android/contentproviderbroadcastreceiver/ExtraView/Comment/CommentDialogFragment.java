package com.example.android.contentproviderbroadcastreceiver.ExtraView.Comment;
...
//            id = args.getLong("id", -1);
            ...
            Class c = RealmDataHelper.getInstance().getClass(args.getInt("type"));
            long id = args.getLong("id");
            item = (MyRealmObject) realm.where(c).equalTo("id", id).findFirst();
